...
{
  $sql="UPDATE `".$_SESSION["abranch"]."-".$_SESSION["ayear"]."-".$_SESSION['asection']."` SET `status`='off' WHERE `no`='$no' LIMIT 1";
  if (mysqli_query($db,$sql))
    {
      $_SESSION["msg"]="Student <strong>".$_SESSION["rname"]."</strong> is Removed.";
